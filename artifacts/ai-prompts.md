...
- Asset path: `public/artifacts/dashboard-hero.png`
- Status: replaced with provided final artwork
- Intended use: right-side dashboard editorial artwork
- Prompt:
...
- Asset path: `public/artifacts/signin-journey.png`
- Status: replaced with provided final artwork
- Intended use: sign-in page companion art
- Prompt:
